...
function Nav() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 px-3 sm:px-5 pt-3 sm:pt-5">
      ...
      >
        <a href="#top" className="flex items-center gap-2 pl-1 pr-3 py-1.5">
          <FoxMark className="w-7 h-7 text-ember" />
          <span className="font-display text-base sm:text-lg tracking-tight leading-none pt-0.5 flex items-center gap-2.5">
